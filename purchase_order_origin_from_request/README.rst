===========================================
Purchase Order Origin from Purchase Request
===========================================
...
This module extends the functionality of purchase request and to allow you to add the name of request in the origin field in the purchase order.
...
Create the purchase order from request.
...
This module is part of the `Calyx-purchase-workflow <https://github.com/calyxservicios-group/odoo/odoo-calyx>`_ project on Github.